...
extern "C"
{
	...
	/// </summary>
	/// <param name="id">地图Id</param>
	/// <param name="binary">地图NavMesh Bytes数据）</param>
	/// <returns></returns>
	DllExport bool recast_loadmapbybytes(int id, const unsigned char* binary);
	...
	/// <summary>
	/// 计算随机采样点，给定坐标的圆形范围内，当前最大半径设置为10(目前写死不可调整)
	/// </summary>
	/// <param name="id">地图Id</param>
