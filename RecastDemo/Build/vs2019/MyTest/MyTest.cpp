...
int DoTest()
{
	...
	// Tools::dtStatus status;
		...
		//
		// std::string strPath = "D:\YooZoo\recastnavigation\RecastDemo\Bin\solo_navmesh.bin";
		// std::ifstream inFile(strPath,std::ios::in|std::ios::binary);
		// std::cout << inFile.width() << std::endl;
		// char *content = new char[65535];
		// memset(content, 0, sizeof(content));
		// inFile.read(content, sizeof(content));
		// std::cout << "content len:" << strlen(content) << std::endl;
	//
